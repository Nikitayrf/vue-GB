    ...
    <div class="home">
        ...
        <main>
            <section class="intro">
                ...
                <router-link to="/blog">get started
                ...
                <div class="palette">
                    <div class="project">
                        ...
                        <div class="description">
                            ...
                            <h3 class="description__type">Decor / Artchitecture</h3>
                        </div>
            ...
            <section class="articles">
                ...
                <div class="palette">
                    <ArticleComponent v-for="post, index in ARTICLES?.slice(0, 6)" class="article" :isTime="true"
